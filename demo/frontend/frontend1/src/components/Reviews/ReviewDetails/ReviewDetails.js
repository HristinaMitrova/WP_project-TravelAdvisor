    ...
    return (
        <div className="row">
            ...
            <div className="form-group row">
                <div  name={"name"} className="col-12 text-left" ><b> Title:</b> {term.title} </div>
                <div  name={"amount"}  className="col-12 text-left" ><b>Destination:</b> {term.destinationName} </div>
                <div  name={"veggie"}  className="col-12 text-left" ><b>Description: </b> {term.description}</div>
