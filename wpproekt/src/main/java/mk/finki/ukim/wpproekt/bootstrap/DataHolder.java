package mk.finki.ukim.wpproekt.bootstrap;

import lombok.Getter;
import mk.finki.ukim.wpproekt.model.*;
...
public class DataHolder {
    ...
    public void init(){
        ...
        ppetkovskiReviews.add(new Review("Ubavo iskustvo!","Spanija","Posetete ja Barcelona."));
        ...
        agencies.add(new Agency("RapsodyTravel","Skopje,Macedonia","02 444 666","rapsody@mail.com",ppetkovskiReviews,users,arrangements));

        destinations.add(destinationSpain);

        reviews.add(new Review("The best place on Earth!","Spain","Ibiza is the best Spanish island in Mediteranian See."));
        ...
        agencies.add(new Agency("Balkan Fun","Skopje,Macedonia","02 727 272","rapsody@mail.com",reviews,users,arrangements));

        reviews.add(new Review("Cultural shock.","Turkey","Istanbul offers a very unique cultural experience."));
        ...
        agencies.add(new Agency("Savana Tours","Skopje,Macedonia","02 246 286","rapsody@mail.com",reviews,users,arrangements));

        reviews.add(new Review("Urban city.","Portugal","Lisbon is a European MUST SEE."));
        ...
        agencies.add(new Agency("Iguana Travel","Skopje,Macedonia","02 259 378","iguanatravel@mail.com",reviews,users,arrangements));
    }
}
